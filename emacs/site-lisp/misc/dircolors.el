...
(defvar dircolors-face-color 
  '(
    (dircolors-face-dir            "mediumblue"        )
    (dircolors-face-text           "purple")
    (dircolors-face-doc            "purple")
    ...
    (dircolors-face-lang           "cyan"         )
    (dircolors-face-emacs          "steelblue"    )
	...
	(dircolors-face-script         "steelblue")
    ))

(defvar dircolors-extension
       '((("txt" "doc" "tex" "texi" "man" "w"
	   (r "README") (r "readme")
	   )                                dircolors-face-doc)
	 ...
	 (("el" "sh" "rb" "pl" "py" "php")                    dircolors-face-script)
	 )
